    ...
    public void attach(final View attachView, final Func<View> copyViewCreator, final Listener listener) {
        attachView.setOnTouchListener(new OnTouchListener() {
            protected void init() {
                ...
                Log.e(TAG, "init attachView.getWidth() / 2"+ attachView.getWidth() / 2);
...
//                tipImageView.measure(0, 0);
                ...
                tipImageView.setX(x - tipImageView.getMeasuredWidth() / 2);
                tipImageView.setY(y - tipImageView.getMeasuredHeight() / 2);

                Log.e(TAG, "init tipImageView.getWidth() / 2" + tipImageView.getHeight() / 2);
                Log.e(TAG, "init tipImageView.getMeasuredWidth() / 2" + tipImageView.getMeasuredHeight() / 2);
   ...
   /* @Override
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        Log.e(TAG, "onMeasure " +( MeasureSpec.getMode(widthMeasureSpec)>>30) + ":" + MeasureSpec.getSize(widthMeasureSpec));
        Log.e(TAG, "onMeasure " +( MeasureSpec.getMode(heightMeasureSpec)>>30) + ":" + MeasureSpec.getSize(heightMeasureSpec));

...
public class TabItemView extends ViewGroup{
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.e("TabItemView", "noheight(): " + noheight+"nowidth(): " + nowidth);
        Log.e("TabItemView", "getMeasuredWidth(): " + getMeasuredWidth()+"getMeasuredHeight(): " + getMeasuredHeight());
        final LayoutParams lp = notifyView.getLayoutParams();
        if (lp != null)
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        Log.e( "onLayout", "notifyView.getMeasuredWidth() " + notifyView.getMeasuredWidth() + ":" + notifyView.getMeasuredHeight());
    }
